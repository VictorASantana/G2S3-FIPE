...
def main():
    ...
    try:
        ...
        time.sleep(3)
        select_option(driver, "Selecione a Marca", "Ford")
        select_option(driver, "Selecione o Modelo", "Focus")
        select_option(driver, "Selecione o Veículo", "2019")

        select_option(driver, "Ano Inicial", '2007')
        select_option(driver, "Ano Final", '2008')
